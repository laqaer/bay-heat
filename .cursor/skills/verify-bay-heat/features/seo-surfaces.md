...
- **Sitemap.** Run `bay-heat get /sitemap.xml --expect "https://bayheatguide.com</loc>" --expect "https://bayheatguide.com/120v-vs-240v-garage-heater" --expect "https://bayheatguide.com/about" --expect "https://bayheatguide.com/privacy"`. Status is `200`. Also expect locs for `/best-electric-garage-heaters-by-size`, `/forced-air-vs-infrared-garage-heater`, `/best-ceiling-mount-garage-heaters-under-200`, `/portable-garage-heaters-15a-circuit`, `/wall-mount-vs-ceiling-garage-heater`, `/best-wall-mount-garage-heaters`, `/best-infrared-garage-heaters`, and `/insulate-garage-before-heater-upgrade`.
